...
export default function BankLedgerPage() {
  ...
  const handleExportExcel = async () => {
    ...
    exportToExcel({ fileName: `Bank-Ledger_${bankAccount.accountName}.xlsx`, sheets: [{ name: "Bank Ledger", headers, rows }], company });
  };
  ...
  const handleExportPDF = async () => {
    ...
    exportToPDF({ fileName: `Bank-Ledger_${bankAccount.accountName}.pdf`, title: `Bank Ledger — ${bankAccount.accountName}`, subtitle: `${bankAccount.bankName} | ${dateRange}`, sheets: [{ name: "Bank Ledger", headers, rows }], company });
  };
