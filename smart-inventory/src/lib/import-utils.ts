...
export const ENTITY_FIELDS: Record<EntityType, ImportField[]> = {
  ...
  SALES_INVOICE: [
    { key: 'invoiceNumber', label: 'Invoice Number', required: true, type: 'string', aliases: ['invoice no', 'inv no', 'bill no', 'sap ref'] },
    { key: 'invoiceDate', label: 'Invoice Date', required: true, type: 'date', aliases: ['invoice dt', 'bill date', 'date'] },
    { key: 'customerName', label: 'Customer Name', required: true, type: 'fk', fkEntity: 'customer', fkMatchField: 'name', aliases: ['party name', 'buyer name', 'bill to', 'customer'] },
    { key: 'customerGstin', label: 'Customer GSTIN', required: false, type: 'string', maxLength: 15, aliases: ['buyer gstin', 'party gstin', 'gstin'] },
    { key: 'dueDate', label: 'Due Date', required: false, type: 'date', aliases: ['payment due', 'due on'] },
    { key: 'itemName', label: 'Item Name', required: true, type: 'fk', fkEntity: 'item', fkMatchField: 'name', aliases: ['description', 'product name', 'product description', 'particulars', 'item description', 'material description', 'goods description'] },
    { key: 'itemCode', label: 'Item Code', required: false, type: 'string', aliases: ['article code', 'sku', 'product code', 'user code', 'pack code', 'article no', 'material code', 'item no'] },
    { key: 'hsnCode', label: 'HSN Code', required: false, type: 'string', maxLength: 8, aliases: ['hsn', 'hsn/sac', 'hsn code', 'sac code', 'hsn/sac code'] },
    { key: 'quantity', label: 'Quantity', required: true, type: 'decimal', aliases: ['qty', 'nos', 'pcs', 'total qty', 'billed qty', 'shipped qty'] },
    { key: 'unit', label: 'Unit', required: false, type: 'string', aliases: ['uom', 'unit of measure', 'uom code', 'unit name'] },
    { key: 'rate', label: 'Rate', required: true, type: 'decimal', aliases: ['unit rate', 'unit price', 'price', 'mrp', 'rate per unit', 'basic rate', 'base rate', 'rate/unit'] },
    { key: 'discountPercent', label: 'Discount %', required: false, type: 'decimal', aliases: ['disc %', 'discount', 'disc', 'disc%', 'discount%', 'disc. %'] },
    { key: 'taxRate', label: 'Tax Rate %', required: false, type: 'decimal', unit: '%', aliases: ['gst %', 'gst rate', 'tax %', 'igst %', 'igst rate', 'tax rate'] },
    { key: 'cgstRate', label: 'CGST %', required: false, type: 'decimal', unit: '%', aliases: ['cgst rate', 'cgst%', 'cgst rate %', 'c.gst %'] },
    { key: 'sgstRate', label: 'SGST %', required: false, type: 'decimal', unit: '%', aliases: ['sgst rate', 'sgst%', 'sgst rate %', 's.gst %'] },
    { key: 'notes', label: 'Notes', required: false, type: 'string', aliases: ['remarks', 'comment', 'narration'] },
    { key: 'ref', label: 'Ref / Source', required: false, type: 'string', aliases: ['reference', 'source', 'po number', 'po no', 'ref no'] },
  ],
  PURCHASE_INVOICE: [
    { key: 'invoiceNumber', label: 'Invoice Number', required: true, type: 'string', aliases: ['bill no', 'invoice no', 'inv no', 'document no', 'sap ref', 'sap reference no'] },
    { key: 'date', label: 'Date', required: true, type: 'date', aliases: ['invoice date', 'invoice dt', 'bill date', 'document date'] },
    { key: 'dueDate', label: 'Due Date', required: false, type: 'date', aliases: ['payment due', 'due on'] },
    { key: 'vendorName', label: 'Vendor Name', required: true, type: 'fk', fkEntity: 'vendor', fkMatchField: 'name', aliases: ['supplier name', 'party name', 'seller name', 'vendor'] },
    { key: 'vendorGstin', label: 'Vendor GSTIN', required: false, type: 'string', maxLength: 15, aliases: ['supplier gstin', 'party gstin', 'seller gstin', 'gstin'] },
    { key: 'itemName', label: 'Item Name', required: true, type: 'fk', fkEntity: 'item', fkMatchField: 'name', aliases: ['description', 'product name', 'product description', 'particulars', 'item description', 'material description', 'goods description'] },
    { key: 'itemCode', label: 'Item Code', required: false, type: 'string', aliases: ['article code', 'sku', 'product code', 'user code', 'pack code', 'article no', 'material code', 'item no'] },
    { key: 'hsnCode', label: 'HSN Code', required: false, type: 'string', maxLength: 8, aliases: ['hsn', 'hsn/sac', 'sac code', 'hsn/sac code'] },
    { key: 'quantity', label: 'Quantity', required: true, type: 'decimal', aliases: ['qty', 'nos', 'pcs', 'total qty', 'billed qty', 'shipped qty'] },
    { key: 'unit', label: 'Unit', required: false, type: 'string', aliases: ['uom', 'unit of measure', 'uom code', 'unit name'] },
    { key: 'rate', label: 'Rate', required: true, type: 'decimal', aliases: ['unit rate', 'unit price', 'price', 'base rate', 'basic rate', 'rate per unit', 'rate/unit'] },
    { key: 'discountPercent', label: 'Discount %', required: false, type: 'decimal', aliases: ['disc %', 'discount', 'disc', 'disc%', 'discount%', 'disc. %'] },
    { key: 'taxRate', label: 'Tax Rate %', required: false, type: 'decimal', unit: '%', aliases: ['gst %', 'gst rate', 'tax %', 'igst %', 'igst rate', 'tax rate'] },
    { key: 'cgstRate', label: 'CGST %', required: false, type: 'decimal', unit: '%', aliases: ['cgst rate', 'cgst%', 'cgst rate %', 'c.gst %'] },
    { key: 'sgstRate', label: 'SGST %', required: false, type: 'decimal', unit: '%', aliases: ['sgst rate', 'sgst%', 'sgst rate %', 's.gst %'] },
