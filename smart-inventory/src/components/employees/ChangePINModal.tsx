  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="bg-gradient-to-r from-indigo-900 to-[#1E1B4B] px-6 py-5 flex items-center justify-between">
          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-11 bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-10 text-sm text-gray-800 tracking-[0.2em] placeholder:tracking-normal focus:outline-none focus:ring-2 focus:ring-indigo-400/20 focus:border-indigo-400/40 transition-all"
                    required
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full mt-1 bg-indigo-900 hover:bg-[#1E1B4B] disabled:bg-gray-100 disabled:text-gray-400 text-white text-sm font-semibold py-3 rounded-xl transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
